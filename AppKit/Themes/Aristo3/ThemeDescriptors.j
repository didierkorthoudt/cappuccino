...
+ (CPButton)makeButton
{
    return [[CPButton alloc] initWithFrame:CGRectMake(0, 0, 100, 25)];
}
...
//                                                       @"-moz-box-sizing": @"border-box",
    ...
    defaultHighlightedButtonCssColor = [CPColor colorWithCSSDictionary:@{
                                                                         ...
                                                                         @"border-radius": @"3px",
                                                                         @"box-sizing": @"border-box",
                                                                         @"background-color": @"rgb(0,103,216)"
                                                                         }],
    ...
    [
     ...
     [@"text-color",            A3ColorActiveText],
     [@"text-color",            A3ColorInactiveText,                CPThemeStateDisabled],
     [@"text-color",            A3ColorDefaultText,                 [CPThemeStateBordered, CPThemeStateDefault]],
     [@"text-color",            A3ColorDefaultText,                 CPThemeStateDefault],
     [@"text-color",            A3ColorInactiveText,                [CPThemeStateDefault,   CPThemeStateDisabled]],
     ...
     [@"bezel-color",           defaultButtonCssColor,              [CPThemeStateBordered, CPThemeStateDefault]],
...
{
    return [[CPSlider alloc] initWithFrame:CGRectMake(0.0, 0.0, 100.0, 24.0)];
}
...
+ (CPSlider)themedHorizontalSlider
{
    ...
    leftDisabledTrackCssColor = [CPColor colorWithCSSDictionary:@{
                                                                  @"background-color": @"rgb(125,186,253)"
                                                                  }],
    ...
    [
     ...
     // Omit those 2 lines if you want a only one color slider
     [@"left-track-color", leftTrackCssColor],
     [@"left-track-color", leftDisabledTrackCssColor,   CPThemeStateDisabled],
     
     [@"knob-size",  CGSizeMake(16, 16)],
...
{
    return [[CPSlider alloc] initWithFrame:CGRectMake(0.0, 0.0, 24.0, 100.0)];
}
...
+ (CPSlider)themedVerticalSlider
{
    ...
    [
     ...
     // Omit those 2 lines if you want a only one color slider
     [@"left-track-color", leftTrackCssColor,   CPThemeStateVertical],
